...
% 27-09-2025
%==========================================================================
% The purpose of this function is to estimate the Star Tracker
% measaurements
%==========================================================================

function z_ST = StarTracker(x_true, noise_ST)
...
for i = 1:d
    % True star direction in body frame
    ...
    v_noisy = cos(theta)*v + sin(theta)*cross(axis,v) + (1-cos(theta))*(axis.'*v)*axis;

    % Ensure unit vector
    z_ST(:,i) = v_noisy / norm(v_noisy);
end
